...
am4internal_webpackJsonp(
  ["689e"],
  {
    XFs4: function (e, t, i) {
          ...
          return (
            ...
            (t.prototype.validate = function () {
              if ((e.prototype.validate.call(this), !this.isTemplate)) {
                ...
                if (
                  ((this.middleLine.tensionX = I),
                  (this.middleLine.tensionY = D),
                  m.isNumber(s) &&
                    m.isNumber(t) &&
                    m.isNumber(n) &&
                    m.isNumber(i) &&
                  ...
                  var T = Math.min(g, f, c, d),
                    ...
                    _ = Math.max(g, f, c, d),
                    k = Math.max(v, x, p, y);
                  this._bbox = { x: T, y: V, width: _ - T, height: k - V };
            ...
            (t.prototype.draw = function () {
              ...
              if ("vertical" == this.orientation) {
                ...
                (y = { y: b.y + (A.y - b.y) / 2 - s * a, x: b.x + 0.5 * a }),
                  (g = { y: P.y + (I.y - P.y) / 2 + s * a, x: P.x + 0.5 * a }),
                  (f = h.lineTo(A)),
                  (m = "");
                0 != s &&
      ...
      (l.c.registeredClasses.ConeSeries = Dt),
